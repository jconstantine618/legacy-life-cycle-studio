  ...
  return (
    <div className="relative overflow-hidden bg-[linear-gradient(180deg,#f5ecdf_0%,#fbf8f3_42%,#f3ece1_100%)]">
      ...
      <div className="container relative py-8 md:py-12">
        ...
        <div className="grid gap-8 xl:grid-cols-[1fr_1fr]">
                    ...
                    return (
                      <div key={category.id}>
                        <div className="flex items-center justify-between mb-1.5">
                          ...
                          <span
                            className={`min-w-[2rem] rounded-full px-2 py-0.5 text-center text-xs font-bold ${
                              value >= 7
          ...
          <div className="space-y-6">
            ...
            <div className="sticky top-20">
              ...
              {/* Timeline Bar */}
              <Card className="mt-6 border-white/60 bg-white/75 shadow-md">
        ...
        {/* INSIGHTS SECTION - Full Width Below */}
              ...
              <CardContent className="p-8">
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-3">
                  <div className="rounded-2xl bg-slate-50 p-4 text-center">
                    <p className="text-3xl font-bold text-slate-900">{insight.yearsLived}</p>
                    <p className="text-xs text-slate-500 uppercase tracking-wider mt-1">Years lived</p>
                  </div>
                  <div className="rounded-2xl bg-slate-50 p-4 text-center">
                    <p className="text-3xl font-bold text-slate-900">{insight.yearsRemaining}</p>
                    <p className="text-xs text-slate-500 uppercase tracking-wider mt-1">Years remaining</p>
                  </div>
                  <div className="rounded-2xl bg-slate-50 p-4 text-center">
                    <p className="text-3xl font-bold text-slate-900">
                      {Math.round(insight.yearsRemaining / 5)}
                    </p>
                    <p className="text-xs text-slate-500 uppercase tracking-wider mt-1">Five-year chapters left</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-2">
                  {insight.fiveYearSegments.map((seg, i) => (
                    ...
                    >
                      ...
                      />
                      <span className="w-16 text-right text-xs" style={{ color: seg.season.colors.ink }}>
                        {seg.season.name}
                      </span>
                      {seg.isCurrent && (
                        <span className="ml-1 text-xs font-bold" style={{ color: seg.season.colors.ink }}>
                          ← You
                        </span>
                      )}
                    </div>
